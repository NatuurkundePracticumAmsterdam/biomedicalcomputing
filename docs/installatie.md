...
!!! opdracht-basis "Instellingen Visual Studio Code"
    ...
    2. Als je een venster krijgt met _Welcome to VS Code / Continue with GitHub_ klik dan rechtsonderin op _Continue without Signing In_.
    3. Kies via het dropdownmenu **File** voor **Preferences > Settings**.
